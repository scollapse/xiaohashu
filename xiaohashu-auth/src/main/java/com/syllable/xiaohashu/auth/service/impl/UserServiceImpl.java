...
import com.syllable.framework.common.enums.DeletedEnum;
import com.syllable.framework.common.enums.StatusEnum;
...
import com.syllable.xiaohashu.auth.filter.LoginUserContextHolder;
    ...
    public Long registerUser(String phone) {
        return transactionTemplate.execute(status -> {
            try {
                ...
                log.error("==> 系统自动注册用户失败, phone: {}, e: {}", phone, e);
                return null;
            }
        });
    }
